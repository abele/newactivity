...
public abstract class OwnerListView_Roo_Gwt extends AbstractProxyListView<OwnerProxy> {

    @UiField
    CellTable<OwnerProxy> table;

    protected Set<String> paths = new HashSet<String>();

    public void init() {
        paths.add("id");
        table.addColumn(new TextColumn<OwnerProxy>() {
            ...
            @Override
            public String getValue(OwnerProxy object) {
