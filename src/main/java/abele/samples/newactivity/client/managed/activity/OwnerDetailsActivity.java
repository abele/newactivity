...
public class OwnerDetailsActivity extends OwnerDetailsActivity_Roo_Gwt {

    private final PlaceController placeController;

    private final ProxyDetailsView<OwnerProxy> view;

    private AcceptsOneWidget display;

    public OwnerDetailsActivity(EntityProxyId<abele.samples.newactivity.client.managed.request.OwnerProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, ProxyDetailsView<abele.samples.newactivity.client.managed.request.OwnerProxy> view) {
    ...
    public void deleteClicked() {
        ...
        requests.ownerRequest().remove().using(view.getValue()).fire(new Receiver<Void>() {
    ...
    public Place getBackButtonPlace() {
        return new ProxyListPlace(OwnerProxy.class);
    }
    ...
    public void start(AcceptsOneWidget displayIn, EventBus eventBus) {
        ...
        Receiver<EntityProxy> callback = new Receiver<EntityProxy>() {
            ...
            public void onSuccess(EntityProxy proxy) {
                ...
                view.setValue((OwnerProxy) proxy);
