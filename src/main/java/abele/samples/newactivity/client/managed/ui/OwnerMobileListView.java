...
public class OwnerMobileListView extends OwnerMobileListView_Roo_Gwt {

    private static abele.samples.newactivity.client.managed.ui.OwnerMobileListView instance;

    public OwnerMobileListView() {
        super("New Owner", new CellRenderer());
        init();
    }

    public static abele.samples.newactivity.client.managed.ui.OwnerMobileListView instance() {
        if (instance == null) {
            instance = new OwnerMobileListView();
        }
        return instance;
    }
    ...
    private static class CellRenderer extends AbstractSafeHtmlRenderer<OwnerProxy> {
        ...
        @Override
        public SafeHtml render(OwnerProxy value) {
            if (value == null) {
