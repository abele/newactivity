...
import abele.samples.newactivity.client.managed.activity.*;
import abele.samples.newactivity.client.managed.request.ApplicationRequestFactory;
import abele.samples.newactivity.client.managed.ui.ApplicationListPlaceRenderer;
import abele.samples.newactivity.client.scaffold.activity.IsScaffoldMobileActivity;
import abele.samples.newactivity.client.scaffold.place.*;
import abele.samples.newactivity.client.style.MobileListResources;
