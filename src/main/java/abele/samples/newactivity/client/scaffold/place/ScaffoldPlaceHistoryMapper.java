package abele.samples.newactivity.client.scaffold.place;
 ...
 * {@link abele.samples.newactivity.client.scaffold.place.Place Place}s your app can navigate to. In
 ...
 * {@link abele.samples.newactivity.client.scaffold.place.ProxyListPlace ProxyListPlace}s (which show
 * all entities of a particular type) and
 * {@link abele.samples.newactivity.client.scaffold.place.ProxyPlace ProxyPlace}s (which give access to
